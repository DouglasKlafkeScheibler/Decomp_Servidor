...
#Função que pega as informações de "GERACAO TERMICA NOS SUSBSISTEMAS" do sumário
def thermalGenerationSubsystem(content):
    header = [
        'ssis', 'sem_01',
        'sem_02', 'sem_03',
        'sem_04', 'sem_05',
    ...
    for line in lines:
        ...
        if 'GERACAO TERMICA NOS SUSBSISTEMAS' in line:
            validy = True
