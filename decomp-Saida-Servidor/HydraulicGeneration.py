...
#Função que pega as informações de "GERACAO HIDRAULICA (MWmed) PARA O PATAMAR" do sumário
def hydraulicGeneration(content):
    header = [
        'number', 'usina',
        'sem_01', 'sem_02',
        'sem_03', 'sem_04', 
    ...
    for line in lines:
        ...
        if 'GERACAO HIDRAULICA (MWmed) PARA O PATAMAR 1' in line:
            validy = True
